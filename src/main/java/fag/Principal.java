...
public class Principal {
	...
	public static void questao1_Scanner(Scanner scan) {
		...
		System.out.printf("Olá %s! Você tem %d anos. Seja bem-vindo(a)!", nomeUsuario, idadeUsuario);
	}
	...
	public static void questao9_WhileScanner(Scanner scan) {
		...
		float inputUsuario = 1;
		int qtdNumerosPositivos = 0;
		
		while (inputUsuario >= 0)
		{
			System.out.print("Digite um número: ");
			inputUsuario = scan.nextFloat();
		...
		System.out.println(qtdNumerosPositivos);
	...
	public static long calcularFatorial(int n) {
		...
		return resultado; // Remova esta linha e implemente a lógica
	}
}