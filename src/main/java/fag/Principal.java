...
public class Principal {
	...
	public static void questao6_Metodos() {
		System.out.println("=== QUESTÃO 6 - MÉTODOS ===");
	     ...
	     System.out.println("O número maior é:" + encontrarMaior(10, 5));
	     System.out.println("O número maior é:" + encontrarMaior(1, 7));
	     System.out.println("O número maior é:" + encontrarMaior(12, 9));
	}
