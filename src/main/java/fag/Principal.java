...
public class Principal {
	...
	public static void questao3_For() {
		...
		System.out.printf("a soma dos numeros de 1 até 100 e: %d", soma);
	}
	...
	public static void questao9_WhileScanner(Scanner scan) {
		...
		System.out.printf("a quantidade de positivos digitados foi: %d", contador);
	}
